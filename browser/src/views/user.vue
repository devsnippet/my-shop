...
<div class="user">
    <blur class="blurbg" height="11rem" :blur-amount=40 url="https://unsplash.it/150/150/?random">
        <p class="center">
...
<div class="order">
    ...
    <ul>
        <li>
            <img alt="1" src="https://unsplash.it/50/50/?random"></img>
            <p>代付款</p>
        </li>
        <li>
            <img alt="1" src="https://unsplash.it/50/50/?random"></img>
...
<div class="menus">
    <group>
        <cell class="cell" title="意见反馈" is-link link="#">
            <img class="icon" slot="icon" src="https://unsplash.it/100/150/?random"></img>
        </cell>
